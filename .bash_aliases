...
alias cop='bundle exec rubocop -D --rails -a | grep "C:\|E:"'
...
alias xmain='xrandr --output HDMI-1 --off --output VGA-1 --auto --output eDP-1 --off'
alias xdouble='xrandr --output HDMI-1 --auto --output VGA-1 --auto --right-of HDMI-1 --output eDP-1 --auto --right-of VGA-1 --mode "2880x1620" --scale "0.5x0.5"'
